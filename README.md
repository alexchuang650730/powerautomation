...
![PowerAutomation MCP 系统架构图](docs/images/mcp_architecture_updated.png)
...
1. **接口调用**：MCP Planner通过Python的ctypes或CFFI调用mcp.so提供的接口
...
6. 记录器全程记录思考和操作过程
7. 测试收集器收集问题并反馈给Agent问题解决驱动器
8. Agent问题解决驱动器生成解决方案并推送至GitHub
9. Release管理器管理版本发布和更新，与GitHub Actions协同工作
