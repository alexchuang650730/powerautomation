...
layer_width = 8  # 保持宽度
layer_margin = 0.2  # 减小间距
layer_start_y = 11  # 调整起始位置
layer_x = 2

# 绘制标题
ax.text(layer_x + layer_width/2, layer_start_y + 0.8, "PowerAutomation 分层架构图", 
...
# 设置坐标轴 - 紧凑布局，去除多余空白
ax.set_xlim(layer_x - 0.5, layer_x + layer_width + 0.5)
ax.set_ylim(layer_start_y - len(layers) * (layer_height + layer_margin) - 0.5, layer_start_y + 1.2)
ax.axis('off')

# 保存图像
output_path = "images/powerautomation_layered_architecture_compact_final.png"
