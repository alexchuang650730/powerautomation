...
try:
    ...
    font_submodule = ImageFont.truetype("DejaVuSans.ttf", 10)
except IOError:
    try:
...
for conn in connections:
    ...
    if conn['label']:
        ...
        text_width = len(label_text) * 10  # 增加宽度
        text_height = 20  # 增加高度
        ...
        # 使用更大的字体绘制文本
        draw.text((mid_x, mid_y), label_text, fill=(0, 0, 0), font=font_label, anchor="mm")
